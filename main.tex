...
% Wir patchen den "book"-Treiber, damit er das Feld "pages" ausgibt
\xpatchbibdriver{book}
  {\usebibmacro{publisher+location+date}} % Suche diese Stelle
  {\usebibmacro{publisher+location+date}%
   \newunit\newblock
   \printfield{pages}} % Füge danach die Seitenzahlen ein
  {}
  {}
...
\title{
    <<Art der Arbeit>>\par
    zur Vorlesung <<Fach>> im <<Semester>>\par
