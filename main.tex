...
\setlength{\parskip}{1em} % Abstand zwischen Paragrafen vergrößern, da mit Zeilenabstand sonst zu klein
...
\setcounter{page}{3} % ggf. anpassen, wenn mit/ohne Inhaltsverzeichnis gearbeitet wird
